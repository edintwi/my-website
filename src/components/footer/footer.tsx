  ...
  return (
    <footer className="flex flex-col px-5 bottom-0 self-end">
      ...
      <div className="flex flex-row justify-between py-10 flex-wrap xsm:justify-center sm:justify-center sm:flex-col sm: items-center">
        ...
        <p className="flex flex-col font-thin xsm:text-sm xsm:justify-center xsm:py-10 sm:py-10">
          Projetado e desenvolvido por{" "}
          <span className="font-semibold bg-gradient-to-r from-cyan-300 to-emerald-500 bg-clip-text text-transparent xsm:text-sm sm:text-center">
            Edson Brandon
          </span>
        </p>
      </div>
